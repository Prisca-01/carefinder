      ...
      <section className="py-16 bg-gray-100 h-[500px]">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-700 mb-4 text-xl">
            Carefinder is your go-to platform for finding healthcare facilities
            with ease. We provide comprehensive listings, user reviews, and easy
            booking options to help you choose the best healthcare services.
          </p>
          <p className="text-gray-700 text-xl">
            Admin users can manage facility entries, utilizing markdown support
            to format content, add links, and insert images, ensuring that the
            information is clear and detailed for all users.
          </p>
        </div>
      </section>
